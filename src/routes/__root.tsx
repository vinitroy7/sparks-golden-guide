...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sparks & Associates – Chartered Accountants in Noida | Tax, GST, Audit" },
      { property: "og:description", content: "Trusted Chartered Accountants in Noida offering GST, ITR, audit, company registration, accounting & financial advisory across India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sparks & Associates – Chartered Accountants in Noida | Tax, GST, Audit" },
      { name: "twitter:description", content: "Trusted Chartered Accountants in Noida offering GST, ITR, audit, company registration, accounting & financial advisory across India." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/89aa8604-4668-4615-9450-c3d4aa704810/id-preview-9482cd48--2565b5bb-58bd-4ebe-ab8c-ee4328b45841.lovable.app-1779267121943.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/89aa8604-4668-4615-9450-c3d4aa704810/id-preview-9482cd48--2565b5bb-58bd-4ebe-ab8c-ee4328b45841.lovable.app-1779267121943.png" },
    ],
